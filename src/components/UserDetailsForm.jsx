  ...
  return (
    <div className="container">
      {!showUserForm ? (
        <div className="relative">
          ...
          <div className="absolute top-32 left-1/2 transform -translate-x-1/2 w-full ">
            <div className="bg-gray-300 bg-opacity-20 backdrop-blur-sm p-6 ">
              <h2 className="text-2xl ml-11 font-bold text-gray-800 mb-2 ">
                Tell us more about you
              </h2>
              <p className="text-gray-600 ml-11 mb-6 text-sm ">
                Please fill in your details to receive <br /> order
                notifications.
              </p>
                ...
                <div className="mb-6">
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-sm text-gray-700">
                      I hereby accept T&C, Privacy Policy
                    </span>
                  </label>
                </div>
        ...
        <MobileNumber setActiveStep={setActiveStep} />
      )}
    </div>
  );
};
